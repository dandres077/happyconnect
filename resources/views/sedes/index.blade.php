            ...
            <div class="kt-portlet__head-toolbar">
                <div class="kt-portlet__head-wrapper">
                    <div class="kt-portlet__head-actions">
                        <a href="{{ url ('admin/sedes/create')}}" class="btn btn-brand btn-elevate btn-icon-sm">
             ...
             <table class="table table-striped table-bordered table-hover dataTables-example" >
                ...
                @foreach ($data as $sedes)
                    ...
                    <tr class="gradeX">
                        ...
                        <td>
                        	@if($sedes->estado_elemento == 'Activo')
                        ...
                        <td>
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                @can('sedes.edit') 
                                <a class="dropdown-item" href="{{ url('admin/sedes/'.$sedes->id.'/edit')}}"><i class="la la-edit"></i>Editar</a>
                                @endcan

                                @can('sedes.destroy')       
                                <form method="post" action="{{ url('admin/sedes/'.$sedes->id)}}" class="formulario-eliminar">
                                    {{ csrf_field() }}
                                ...
                                @if ($sedes->status == 1)
                                    @can('sedes.inactive')         
                                    <form method="post" action="{{ url('admin/sedes/'.$sedes->id.'/inactive')}}">
                                        {{ csrf_field() }}
                                ...
                                @else    
                                    @can('sedes.active')       
                                    <form method="post" action="{{ url('admin/sedes/'.$sedes->id.'/active')}}">
                                        {{ csrf_field() }}
