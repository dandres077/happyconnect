                    ...
                    <tr class="gradeX">
                        ...
                        <td>
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                @can('empresas.edit') 
                                <a class="dropdown-item" href="{{ url('admin/empresas/'.$empresas->id.'/edit')}}"><i class="la la-edit"></i>Editar</a>
                                @endcan

                                @can('empresas.destroy')       
                                <form method="post" action="{{ url('admin/empresas/'.$empresas->id)}}" class="formulario-eliminar">
                                    {{ csrf_field() }}
                                ...
                                @if ($empresas->status == 1)
                                    ...
                                    <form method="post" action="{{ url('admin/empresas/'.$empresas->id.'/inactive')}}">
                                        {{ csrf_field() }}
                                ...
                                @else    
                                    @can('empresas.active')       
                                    <form method="post" action="{{ url('admin/empresas/'.$empresas->id.'/active')}}">
                                        {{ csrf_field() }}
