    ...
    <div class="kt-container  kt-container--fluid ">
        <div class="kt-subheader__main">
            ...
            <div class="kt-subheader__breadcrumbs">
                <a href="{{ url ('admin/tareas')}}" class="kt-subheader__breadcrumbs-home"><i class="flaticon2-shelter"></i></a>
                <span class="kt-subheader__breadcrumbs-separator"></span>
                <a href="{{ url ('admin/tareas')}}" class="kt-subheader__breadcrumbs-link">
                {{ $titulo }}</a>
                <span class="kt-subheader__breadcrumbs-separator"></span>
        ...
        <div class="col-lg-12">
            ...
            <div class="kt-portlet kt-portlet--last kt-portlet--head-lg kt-portlet--responsive-mobile" id="kt_page_portlet">
                ...
                <div class="kt-portlet__body">
                    <form method="post" class="form-horizontal" action="{{ url('admin/tareas/'.$data->id.'/edit')}}" autocomplete="off" enctype="multipart/form-data" onsubmit="return validar(this)">
                    {{ csrf_field()}}
                        <div class="row">
                            ...
                            <div class="col-xl-6">
                                <div class="kt-section kt-section--first">
                                    <div class="kt-section__body">  
                                        ...
                                        <div class="form-group row">
                                            <label class="col-3 col-form-label">Fecha de entrega </label>
                                            <div class="col-9">                            
                                            <input class="form-control" type="date" value="{{ old('fecha_entrega', $data->fecha_entrega) }}" id="fecha_entrega" name="fecha_entrega" required="">       
                                            </div>
                                        </div>  

                                        <div class="form-group row">
                                            <label class="col-3 col-form-label">Tarea </label>
                                            <div class="col-9">
                                            <input type="text" class="form-control" id="tarea" name="tarea" value="{{ old('tarea', $data->tarea) }}" required="">
                                            </div>
                                        </div>
                                        ...
                                        <div class="kt-form__actions">
                                            ...
                                            @endcan
                                            <a href="{{ url ('admin/tareas')}}" class="btn btn-secondary">Cancelar</a>
                                        </div>
                                    </div>
                                </div>
