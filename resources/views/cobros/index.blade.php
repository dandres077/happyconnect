            ...
            <!--begin: Datatable -->
             <table class="table table-striped table-bordered table-hover dataTables-example" >
                ...
                <tr class="gradeX">
                    ...
                    <td>{{$cobros->nom_grado}}</td>
                    <td>{{$cobros->nombre}}</td>
                    <td>{{$cobros->nom_director}}</td>
                    <td>
                        <a href="{{ url('admin/cobros/paralelo/'.$cobros->id)}}" type="button" class="btn btn-primary btn-sm btn-icon btn-circle"><i class="fa fa-eye"></i></a>
                    </td>
                </tr>
                @endforeach 
                </tbody>
