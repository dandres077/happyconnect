             ...
             <table class="table table-striped table-bordered table-hover dataTables-example" >
                ...
                @foreach ($data as $proveedores)
                    ...
                    <tr class="gradeX">
                        ...
                        <td>
                            @if($proveedores->estado_elemento == 'Activo')
                        ...
                        <td>
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                ...
                                <a class="dropdown-item" href="{{ url('admin/proveedores/'.$proveedores->id.'/edit')}}"><i class="la la-edit"></i>Editar</a>
                                @endcan

                                @can('proveedores.destroy')       
                                <form method="post" action="{{ url('admin/proveedores/'.$proveedores->id)}}" class="formulario-eliminar">
                                    {{ csrf_field() }}
                                ...
                                @if ($proveedores->status == 1)
                                    ...
                                    <form method="post" action="{{ url('admin/proveedores/'.$proveedores->id.'/inactive')}}">
                                        {{ csrf_field() }}
                                ...
                                @else    
                                    ...
                                    <form method="post" action="{{ url('admin/proveedores/'.$proveedores->id.'/active')}}">
                                        {{ csrf_field() }}
