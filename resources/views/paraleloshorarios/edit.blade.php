        ...
        <div class="col-lg-12">
            ...
            <div class="kt-portlet kt-portlet--last kt-portlet--head-lg kt-portlet--responsive-mobile" id="kt_page_portlet">
                ...
                <div class="kt-portlet__body">
                    <form method="post" class="form-horizontal" action="{{ url('admin/horarios_paralelos/'.$data->id.'/edit')}}" autocomplete="off" onsubmit="return validar(this)">
                    {{ csrf_field()}}
                        <div class="row">
                            <div class="col-xl-12">
                                    ...
                                    <div class="kt-section__body">  
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-9">
                                                ...
                                                @foreach ($dias as $dia)
                                                    <option value="{{$dia->id}}" @if($data->dia_id==$dia->id) selected @endif> {{ $dia->nombre, $data->dia_id }}</option>
                                                @endforeach
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-9">
                                                ...
                                                @foreach ($docentes as $docente)
                                                    <option value="{{$docente->id}}" @if($data->docente_id==$docente->id) selected @endif> {{ $docente->nombre, $data->docente_id }}</option>
                                                @endforeach
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-9">
                                                ...
                                                @foreach ($bloques as $bloques)
                                                    <option value="{{$bloques->id}}" @if($data->bloque_id==$bloques->id) selected @endif> {{ $bloques->nombre, $data->bloque_id }}</option>
                                                @endforeach                                                
                                                </select>
                                            </div>
                                        </div>
