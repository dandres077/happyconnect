<div class="kt-grid__item   kt-portlet  kt-inbox__aside" id="kt_inbox_aside">
    <a href="{{ url ('admin/mensajes/create')}}" class="btn btn-brand  btn-upper btn-bold">Redactar</a>
    <div class="kt-inbox__nav">
        <ul class="kt-nav">
            <li class="kt-nav__item {{ request()->is('admin/mensajes') ? 'kt-nav__item kt-nav__item--active' : ''}}"> 
                <a href="{{ url ('admin/mensajes')}}" class="kt-nav__link" data-action="list" data-type="inbox">
            ...
            <li class="kt-nav__item {{ request()->is('admin/mensajes/enviados') ? 'kt-nav__item kt-nav__item--active' : ''}}">
                <a href="{{ url ('admin/mensajes/enviados')}}" class="kt-nav__link" data-action="list" data-type="sent">
                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon kt-nav__link-icon">
                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                            <rect x="0" y="0" width="24" height="24" />
            ...
            <!--<li class="kt-nav__item {{ request()->is('admin/mensajes/eliminados') ? 'kt-nav__item kt-nav__item--active' : ''}}">
                <a href="{{ url ('admin/mensajes/eliminados')}}" class="kt-nav__link" data-action="list" data-type="trash">
                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon kt-nav__link-icon">
                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                            <rect x="0" y="0" width="24" height="24" />
