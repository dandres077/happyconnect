                            ...
                            <div class="kt-form__body">
                                <div class="kt-section kt-section--first">
                                    <div class="kt-section__body">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-xl-3 col-lg-3 col-form-label">Grupo sanguineo</label>
                                            <div class="col-lg-9 col-xl-6">
                                                <input class="form-control" type="text" value="{{$alumno->sangre}}" disabled="">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-9 col-xl-6">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control" value="{{$alumno->email_est}}" placeholder="Email" aria-describedby="basic-addon1" disabled="">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
