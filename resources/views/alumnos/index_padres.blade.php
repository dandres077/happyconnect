            ...
            <div class="kt-portlet__head-toolbar">
                <div class="kt-portlet__head-wrapper">
                    <div class="kt-portlet__head-actions">
                        <a href="{{ url ('admin/alumnos/padres/$padre->id/create')}}" class="btn btn-brand btn-elevate btn-icon-sm">
             ...
             <table class="table table-striped table-bordered table-hover dataTables-example" >
                ...
                @foreach ($padres as $padre)
                    ...
                    <tr class="gradeX">
                        ...
                        <a href="{{ url('admin/alumnos/'.$padre->id.'/padres')}}" type="button" rel="tooltip" title="Padres" class="btn btn-success btn-sm btn-icon btn-circle"> <i class="fa fa-users"></i></a>
